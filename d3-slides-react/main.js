...
var data = [
  ...
  { id:2, content: "Data Visualization", color: "#424242", title:"DATA DRIVEN DOCUMENTS/D3", subtitle:"a JavaScript frameworks that bring data to life", 
    data:dataSample,
    action: {
                enter:  function(data){
  ...
  { id:3, content: "Bring Data to Life", color: "#202020", title:"BRING DATA TO LIFE", subtitle:"Bar Graph", 
    data:dataSample,
    action: {
                enter:  function(data){
  ...
  { id:4, content: "This is Slide 3", color: "#009688", title:"BRING DATA TO LIFE", subtitle:"Line Graph", 
  ...
  { id:5, content: "This is Slide 3", color: "#009688", title:"BRING DATA TO LIFE", subtitle:"Scatter Plot", 
  ...
  { id:6, content: "This is Slide 1", color: "#2196F3", title:"BRING DATA TO LIFE", subtitle:"Circles! Circles!", 
    data:[1,2,3,4,5,6,7],
    action: {
                enter:  function(data){
  ...
  { id:7, content: "This is The End", color: "#212121", title:"THE END", subtitle:"Many more to come", 
    data:[],
    action: {
                enter:  function(){},
                update: function(data){
