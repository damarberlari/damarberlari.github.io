...
var App = React.createClass({
  ...
  componentDidMount: function() {
    ...
    d3.selectAll(".button-progress").on("click", this.jump).on("mouseover",function(){d3.select(this).transition().duration(500).attr("opacity",1)}).on("mouseout",function(d){d3.select(this).transition().duration(500).attr("opacity",function(){if(d.id=slideStatus){return 1}else{return 0.2}})})
  },
  update: function() {
